...
/**
 * Full detail of one vacancy, fetched only when needed (e.g. while a worker has
 * a job's detail sheet open). Cached by vacancy id and shared with any other
 * consumer of `qk.vacancy(id)`.
 */
